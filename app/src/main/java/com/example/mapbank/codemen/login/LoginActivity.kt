package com.example.mapbank.codemen.login
...
import com.example.mapbank.codemen.Main2Activity
import com.example.mapbank.codemen.MainActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.mapbank.R.layout.activity_login)
    ...
    fun login() {
        ...
        val progressDialog = ProgressDialog(this@LoginActivity,
            com.example.mapbank.R.style.AppTheme_Dark_Dialog)
